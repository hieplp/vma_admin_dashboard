                ...
                <div class="field">
                  ...
                  <div class="ui corner labeled input">
                    <input
                      type="text"
                      :class="{
                        'blue-req': request.requestType === 'NEW_DOCUMENT',
                        'red-req': request.requestType === 'DELETE_DOCUMENT',
                        'yellow-req': request.requestType === 'UPDATE_DOCUMENT',
                      }"
